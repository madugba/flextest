...
ENV NEXT_PUBLIC_API_URL=http://localhost:3000/v1/api
ENV DATABASE_URL=postgresql://prod_user:QSbM08uqLc7nK81WZfw53%2FID%2BfJ6UAL8@localhost:5432/flextest_db

# Redis (used by timer-sync and lib/redis.ts)
ENV REDIS_HOST=localhost
ENV REDIS_PORT=6379
ENV REDIS_PASSWORD=Z2e0Qjfjsz1WTBUkNq5bjB9yMYxN28rw
ENV REDIS_DB=0
ENV REDIS_TLS=false
