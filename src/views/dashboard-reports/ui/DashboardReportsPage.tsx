...
import { UploadResultsDialog } from '@/features/report-upload-results'
...
export function DashboardReportsPage() {
  ...
  const closeDialog = (action: 'analysis' | 'print' | 'delete' | 'upload') => {
    ...
    <div className="flex-1 overflow-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <UploadResultsDialog
          ...
          onOpenChange={(open) => setDialogState((prev) => ({ ...prev, upload: open }))}
          sessionId={selectedSessionId}
        />
      </div>
    </div>
