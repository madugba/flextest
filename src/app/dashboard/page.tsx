...
export default function DashboardPage() {
  ...
  // SSE stream - updates React Query cache when events arrive
  useMetricsStream()

  // React Query hooks - each component section will use these independently
  ...
  // Show loading if data hasn't arrived yet (even if query completed)
  if (!metrics) {
    return (
      <div className="flex flex-1 items-center justify-center">
        <div className="text-center">
    ...
    <>
      ...
      <main className="flex-1 overflow-auto p-6">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          {/* Business Metrics */}
          <BusinessMetricsSection business={business} />
