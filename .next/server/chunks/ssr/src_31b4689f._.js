...
function SubjectUploadPage() {
        ...
        try {
            ...
            const transformedQuestions = jsonData.map((row, index)=>{
                ...
                if (missingFields.length > 0) {
                    throw new Error(`Row ${index + 2} is missing required fields: ${missingFields.join(', ')}. ` + `Found columns: ${availableColumns.join(', ')}. ` + `Expected columns: question, optionA, optionB, optionC, optionD, answer (case-insensitive)`);
                }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Parsed ${transformedQuestions.length} questions successfully!`);
        } catch (err) {
    ...
    const handleImport = async ()=>{
        if (parsedQuestions.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('No questions to import');
            return;
        }
        try {
            setIsImporting(true);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Successfully imported ${result.success} out of ${result.total} questions!`);
...
//# sourceMappingURL=src_31b4689f._.js.map