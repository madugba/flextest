module.exports = [
"[project]/.next-internal/server/app/api/candidates/reassign/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/candidates/reassign/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const { candidateIds, sessionId } = body;
    if (!Array.isArray(candidateIds) || candidateIds.length === 0 || typeof sessionId !== 'string' || !sessionId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    try {
       ...
       WHERE id = ANY($2::text[])`, [
        ...
        for (const candidateId of ids){
            const { rows } = await client.query(`SELECT DISTINCT subject_id
           FROM subject_combinations
          WHERE candidate_id = $1`, [
                candidateId
            ]);
            for (const { subject_id } of rows){
                await client.query(`INSERT INTO subject_combinations
...
//# sourceMappingURL=%5Broot-of-the-server%5D__88c02f94._.js.map