...
"[project]/node_modules/@tiptap/extension-mathematics/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
var BlockMath = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"].create({
    name: "blockMath",
    group: "block",
    atom: true,
    addOptions () {
    ...
    addCommands () {
        return {
            insertBlockMath: (options)=>(param)=>{
                    let { commands, editor } = param;
    ...
    addNodeView () {
        ...
        return (param)=>{
            ...
            function renderMath() {
                try {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$katex$2f$dist$2f$katex$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].render(node.attrs.latex, innerWrapper, katexOptions);
...
;
;
var InlineMath = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"].create({
    name: "inlineMath",
    group: "inline",
    inline: true,
    atom: true,
    ...
    addCommands () {
        return {
            insertInlineMath: (options)=>(param)=>{
                    let { editor, tr } = param;
                    var _a;
                    ...
                    tr.replaceWith(from, from, this.type.create({
                        latex
                    }));
                    return true;
                },
            deleteInlineMath: (options)=>(param)=>{
                    let { editor, tr } = param;
                    var _a;
                    const pos = (_a = options == null ? void 0 : options.pos) != null ? _a : editor.state.selection.$from.pos;
                    const node = editor.state.doc.nodeAt(pos);
            ...
            updateInlineMath: (options)=>(param)=>{
                    let { editor, tr } = param;
                    const latex = options == null ? void 0 : options.latex;
                    let pos = options == null ? void 0 : options.pos;
                    if (pos === void 0) {
    ...
    addNodeView () {
        ...
        return (param)=>{
            ...
            function renderMath() {
                try {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$katex$2f$dist$2f$katex$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].render(node.attrs.latex, wrapper, katexOptions);
...
// src/mathematics.ts
var Mathematics = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Extension"].create({
    name: "Mathematics",
    addOptions () {
        return {
...
function createMathMigrateTransaction(editor, tr) {
    let regex = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : mathMigrationRegex;
    tr.doc.descendants((node, pos)=>{
        ...
        match.forEach((mathMatch)=>{
            ...
            tr.replaceWith(tr.mapping.map(pos + start), tr.mapping.map(pos + end), inlineMath.create({
...
function migrateMathStrings(editor) {
    let regex = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : mathMigrationRegex;
...
//# sourceMappingURL=node_modules_%40tiptap_badad0e7._.js.map