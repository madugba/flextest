...
"[project]/src/app/questions/upload/[sessionId]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SessionUploadQuestionsPage() {
    ...
    const [questionStats, setQuestionStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const loadSessionAndStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SessionUploadQuestionsPage.useCallback[loadSessionAndStats]": async function() {
            ...
            try {
                ...
                if (bypassCache) {
                    await new Promise({
                        "SessionUploadQuestionsPage.useCallback[loadSessionAndStats]": (resolve)=>setTimeout(resolve, 800)
                    }["SessionUploadQuestionsPage.useCallback[loadSessionAndStats]"]);
                }
                const sessionData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$entities$2f$exam$2d$session$2f$api$2f$examSessionApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getExamSessionById"])(sessionId);
                setSession(sessionData);
                const sessionSubjects = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$entities$2f$subject$2f$api$2f$subjectApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSubjectsForSession"])(sessionId);
                const statsPromises = sessionSubjects.map({
                    "SessionUploadQuestionsPage.useCallback[loadSessionAndStats].statsPromises": async (subject)=>{
                        try {
                            const { count } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$entities$2f$question$2f$api$2f$questionApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQuestionCount"])(subject.id, sessionId, bypassCache);
                            ...
                            console.error("Failed to get count for subject ".concat(subject.id, ":"), err);
                            return {
                                subject,
                                uploaded: 0,
                                required: 0,
                ...
                }["SessionUploadQuestionsPage.useCallback[loadSessionAndStats].statsPromises"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SessionUploadQuestionsPage.useEffect": ()=>{
            if (sessionId) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SessionUploadQuestionsPage.useEffect": ()=>{
            const handleVisibilityChange = {
                "SessionUploadQuestionsPage.useEffect.handleVisibilityChange": ()=>{
            ...
            return ({
                "SessionUploadQuestionsPage.useEffect": ()=>document.removeEventListener('visibilitychange', handleVisibilityChange)
            })["SessionUploadQuestionsPage.useEffect"];
        }
    }["SessionUploadQuestionsPage.useEffect"], [
        sessionId,
    ...
    const handleUpload = (subjectId)=>{
        router.push("/questions/upload/".concat(sessionId, "/").concat(subjectId));
    };
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    ...
                                                    totalRequired,
                                                    " questions uploaded",
                                                    exceedsLimit && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-red-600 font-medium ml-2",
                                                        children: [
                                                            "• Exceeds session limit (",
                                                            session === null || session === void 0 ? void 0 : session.totalQuestion,
                                                            ")"
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/src/app/questions/upload/[sessionId]/page.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "h-3 transition-all duration-500 ".concat(overallProgress === 100 ? 'bg-green-500' : exceedsLimit ? 'bg-red-500' : 'bg-blue-500'),
                                    style: {
                                        width: "".concat(Math.min(overallProgress, 100), "%")
                                    }
                                }, void 0, false, {
                                    fileName: "[project]/src/app/questions/upload/[sessionId]/page.tsx",
                                    lineNumber: 221,
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        ...
                                        children: questionStats.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-6 py-4 whitespace-nowrap",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-sm font-semibold ".concat(remaining === 0 ? 'text-green-600' : 'text-orange-600'),
                                                            children: remaining
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/questions/upload/[sessionId]/page.tsx",
                                                            lineNumber: 291,
...
_s(SessionUploadQuestionsPage, "5RmQoBRiunvDXUZqTtcivnwPHG4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"]
    ];
});
_c = SessionUploadQuestionsPage;
var _c;
__turbopack_context__.k.register(_c, "SessionUploadQuestionsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_562ab5a9._.js.map